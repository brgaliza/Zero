...
const bootstrapOutputFile = new URL("bootstrap.cjs", outputDirectory);
...
await build({
  bundle: true,
  entryPoints: [fileURLToPath(new URL("../packages/cli/src/bootstrap.ts", import.meta.url))],
  format: "cjs",
  outfile: fileURLToPath(bootstrapOutputFile),
  platform: "node",
  target: "node24",
});
