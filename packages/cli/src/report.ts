...
export async function runReport(input: {
  ...
  try {
    ...
    return {
      ...
      exitCode: 0,
      code: "REPORT_CREATED",
      message: "Relatório seguro criado em ~/.zero/reports/zero-report.json.",
    };
  } catch {
    return {
      ok: false,
      ...
      message:
        "Não foi possível criar o relatório seguro. Contate o suporte e informe este código.",
    };
  }
}
